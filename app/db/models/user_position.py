...
class UserPosition(Base):
    ...
    computation needs (see project_osa_migration_plan memory, Schritt 6
    plan A.1/A.2). The admin UI to assign these (User edit form's
    instrument/voice/choirjob picker) is deliberately Schritt 7
